...
const val BASE_URL = "https://luckyv-streamer.frozenpenguin.media/api"
...
interface LuckyV_StreamerApiService{
    ...
    suspend fun getStreamer(): StreamerList
}
...
object StreamerApi{
    ...
    val retrofitSevice: LuckyV_StreamerApiService by lazy{ retrofit.create(LuckyV_StreamerApiService::class.java)}
}